...
void wrapper_b85ac824f29951a49701a250a473cae3()
{
    ...
    class ::std::shared_ptr< struct ::statiskit::UnivariateDistributionEstimation >  (::statiskit::IrregularUnivariateHistogramDistributionSlopeHeuristicEstimation::Estimator::*method_pointer_0f93d91d30b457cf97bbc88917b14094)(class ::std::shared_ptr< struct ::statiskit::UnivariateData > const &, bool const &) const = &::statiskit::IrregularUnivariateHistogramDistributionSlopeHeuristicEstimation::Estimator::operator();
    ...
    class_b85ac824f29951a49701a250a473cae3.def("__call__", method_pointer_0f93d91d30b457cf97bbc88917b14094, "");
