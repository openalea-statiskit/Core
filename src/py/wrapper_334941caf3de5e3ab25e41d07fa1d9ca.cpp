...
void wrapper_334941caf3de5e3ab25e41d07fa1d9ca()
{
    ...
    ::std::size_t  (::statiskit::VectorEvent::*method_pointer_1c8c650caa5d5e0897419c4a4e31b006)() const = &::statiskit::VectorEvent::size;
    struct ::statiskit::UnivariateEvent const * (::statiskit::VectorEvent::*method_pointer_14e64e202f745427bbfdd5c4b7a65c87)(::std::size_t const &) const = &::statiskit::VectorEvent::get;
    void  (::statiskit::VectorEvent::*method_pointer_546c2692954654889471d670fa584d26)(::std::size_t const &, struct ::statiskit::UnivariateEvent const &) = &::statiskit::VectorEvent::set;
    ...
    class_334941caf3de5e3ab25e41d07fa1d9ca.def(boost::python::init< ::std::size_t const & >(""));
