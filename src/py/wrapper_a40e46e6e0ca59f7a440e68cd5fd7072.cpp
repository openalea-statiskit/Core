...
namespace boost
{
    template <> struct ::statiskit::MultivariateEvent const volatile * get_pointer<struct ::statiskit::MultivariateEvent const volatile >(struct ::statiskit::MultivariateEvent const volatile *c) { return c; }
}
    #endif
#endif
