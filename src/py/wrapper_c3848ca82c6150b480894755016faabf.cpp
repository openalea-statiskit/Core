...
void wrapper_c3848ca82c6150b480894755016faabf()
{
    ...
    class ::std::unique_ptr< struct ::statiskit::UnivariateData, struct ::std::default_delete< struct ::statiskit::UnivariateData > >  (::statiskit::MultivariateDataFrame::*method_pointer_86c4eec981d358ffb89d951709ca042f)(::std::size_t const &) const = &::statiskit::MultivariateDataFrame::extract;
    ...
    ::std::size_t  (::statiskit::MultivariateDataFrame::*method_pointer_675858e74804540f867575e4e24f1873)() const = &::statiskit::MultivariateDataFrame::get_nb_variables;
    class ::statiskit::UnivariateDataFrame const * (::statiskit::MultivariateDataFrame::*method_pointer_682c4154102f5c40b36d9216cff2cda1)(::std::size_t const &) const = &::statiskit::MultivariateDataFrame::get_variable;
    void  (::statiskit::MultivariateDataFrame::*method_pointer_aa8deeaf32bb5bfdaec1cf6adfaf07e7)(::std::size_t const &, class ::statiskit::UnivariateDataFrame const &) = &::statiskit::MultivariateDataFrame::set_variable;
    ...
    void  (::statiskit::MultivariateDataFrame::*method_pointer_3eedcca7cb1a5633b9a0c9394b3de631)(::std::size_t const &, class ::statiskit::UnivariateDataFrame const &) = &::statiskit::MultivariateDataFrame::insert_variable;
    void  (::statiskit::MultivariateDataFrame::*method_pointer_fa2a4da314ab5578bda0e45a3509407a)(::std::size_t const &) = &::statiskit::MultivariateDataFrame::remove_variable;
    ::std::size_t  (::statiskit::MultivariateDataFrame::*method_pointer_10ac8325c1085cec9a39efd69ba41c3c)() const = &::statiskit::MultivariateDataFrame::get_nb_events;
    class ::std::unique_ptr< struct ::statiskit::MultivariateEvent, struct ::std::default_delete< struct ::statiskit::MultivariateEvent > >  (::statiskit::MultivariateDataFrame::*method_pointer_6ad6e1f3747d5172b5d3ab1dcc010a9f)(::std::size_t const &) const = &::statiskit::MultivariateDataFrame::get_event;
    void  (::statiskit::MultivariateDataFrame::*method_pointer_b0f5e788fdc65ce699e64f98105b4c7c)(::std::size_t const &, struct ::statiskit::MultivariateEvent const *) = &::statiskit::MultivariateDataFrame::set_event;
    ...
    void  (::statiskit::MultivariateDataFrame::*method_pointer_014f7c47848152659ad0201bd69f0ab5)(::std::size_t const &, struct ::statiskit::MultivariateEvent const *) = &::statiskit::MultivariateDataFrame::insert_event;
    void  (::statiskit::MultivariateDataFrame::*method_pointer_ce2cebc7034858dabbda327fb270350c)(::std::size_t const &) = &::statiskit::MultivariateDataFrame::remove_event;
