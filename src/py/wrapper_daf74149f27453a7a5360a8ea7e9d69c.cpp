...
namespace boost
{
    ...
    template <> struct ::statiskit::UnivariateDistribution const volatile * get_pointer<struct ::statiskit::UnivariateDistribution const volatile >(struct ::statiskit::UnivariateDistribution const volatile *c) { return c; }
}
    #endif
#endif
...
void wrapper_daf74149f27453a7a5360a8ea7e9d69c()
{
    ...
    if(autowig::Held< struct ::statiskit::UnivariateDistribution >::is_class)
    {
        ...
        boost::python::register_ptr_to_python< autowig::Held< struct ::statiskit::UnivariateDistribution >::Type >();
