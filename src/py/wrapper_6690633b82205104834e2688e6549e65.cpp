...
namespace autowig
{
    ...
    void method_decorator_3c033361e8395d97b8c82e69193a8311(class ::statiskit::WeightedData< struct ::statiskit::UnivariateData >::Generator & instance, struct ::statiskit::UnivariateData::Generator & param_out)     { instance.operator++() = param_out; }
}
