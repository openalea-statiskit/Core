...
void wrapper_939d85e97df35cb48d17558623c03cc2()
{
    ...
    class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  (::statiskit::ContinuousUnivariateMixtureDistribution::*method_pointer_ac17a9d1fe175822aaa87d694c96a32a)() const = &::statiskit::ContinuousUnivariateMixtureDistribution::copy;
    ...
    class_939d85e97df35cb48d17558623c03cc2.def("copy", method_pointer_ac17a9d1fe175822aaa87d694c96a32a, "");
    ...
    {
        boost::python::implicitly_convertible< autowig::Held< struct ::statiskit::ContinuousUnivariateMixtureDistribution >::Type, autowig::Held< struct ::statiskit::QuantitativeUnivariateMixtureDistribution< struct ::statiskit::ContinuousUnivariateDistribution > >::Type >();
