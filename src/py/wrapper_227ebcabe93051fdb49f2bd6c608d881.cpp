...
void wrapper_227ebcabe93051fdb49f2bd6c608d881()
{
    ...
    class_227ebcabe93051fdb49f2bd6c608d881.def(boost::python::init<  >(""));
    class_227ebcabe93051fdb49f2bd6c608d881.def(boost::python::init< struct ::statiskit::NegativeBinomialDistributionMLEstimation::Estimator const & >(""));
