...
void wrapper_fcd0d238df3b57e18bea85b9cc6689bd()
{
    ...
    ::statiskit::Index  (::statiskit::IndependentMultivariateDistribution< ::statiskit::CategoricalMultivariateDistribution >::*method_pointer_4624a4bfed3359c8b93c67f8b0be6813)() const = &::statiskit::IndependentMultivariateDistribution< struct ::statiskit::CategoricalMultivariateDistribution >::get_nb_variables;
