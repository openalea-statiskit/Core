...
void wrapper_30c68813a7c05198a94e1fdadbddc931()
{
    ...
    struct unique_ptr_30c68813a7c05198a94e1fdadbddc931_to_python
    {
        ...
        {
            //return boost::python::incref(boost::python::object(const_cast< class ::std::unique_ptr< struct ::statiskit::MultivariateData, struct ::std::default_delete< struct ::statiskit::MultivariateData > > & >(unique_ptr_30c68813a7c05198a94e1fdadbddc931).release()).ptr());
