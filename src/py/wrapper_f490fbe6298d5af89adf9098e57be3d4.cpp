...
void wrapper_f490fbe6298d5af89adf9098e57be3d4()
{
    ...
    class_f490fbe6298d5af89adf9098e57be3d4.def(boost::python::init< struct ::statiskit::UnivariateData const * >(""));
    class_f490fbe6298d5af89adf9098e57be3d4.def(boost::python::init< class ::statiskit::PoissonDistribution const *, struct ::statiskit::UnivariateData const * >(""));
    ...
    class_f490fbe6298d5af89adf9098e57be3d4.def("get_data", method_pointer_bc4837462b8350e8a5aeb210cd6e7fc4, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
