...
void wrapper_9603102166305920b6c85e3416150e99()
{
    ...
    class_9603102166305920b6c85e3416150e99.def(boost::python::init< class ::std::shared_ptr< struct ::statiskit::QuantitativeUnivariateFrequencyDistribution< struct ::statiskit::ContinuousUnivariateDistribution > > const &, class ::std::shared_ptr< struct ::statiskit::UnivariateData > const & >(""));
    ...
    class_9603102166305920b6c85e3416150e99.def("get_data", method_pointer_7769483fa115513b967c23c4a5b5d3bd, boost::python::return_value_policy< boost::python::return_by_value >(), "");
