...
void wrapper_c64f8514180b56eabe5b4d197177f547(pybind11::module& module)
{
    ...
    class_c64f8514180b56eabe5b4d197177f547.def("_scoring", static_cast<double (::statiskit::PolymorphicCopy< struct ::statiskit::UnivariateDistributionEstimation::Estimator::*)( struct ::statiskit::UnivariateDistribution const *,  struct ::statiskit::UnivariateData const & ) const>(&autowig::Publicist::scoring), "");
