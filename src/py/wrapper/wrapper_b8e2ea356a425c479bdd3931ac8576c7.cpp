...
namespace boost
{
    template <> class ::std::unique_ptr< class ::statiskit::WeightedUnivariateData, struct ::std::default_delete< class ::statiskit::WeightedUnivariateData > > const volatile * get_pointer<class ::std::unique_ptr< class ::statiskit::WeightedUnivariateData, struct ::std::default_delete< class ::statiskit::WeightedUnivariateData > > const volatile >(class ::std::unique_ptr< class ::statiskit::WeightedUnivariateData, struct ::std::default_delete< class ::statiskit::WeightedUnivariateData > > const volatile *c) { return c; }
}
    #endif
#endif
