...
namespace autowig
{
    ...
    void method_decorator_dcafe6784ad0578094810e9dc6ceb523(class ::std::unique_ptr< class ::statiskit::VarianceEstimation, struct ::std::default_delete< class ::statiskit::VarianceEstimation > > const & instance, const class ::statiskit::VarianceEstimation & param_out) { instance.operator*() = param_out; }
}
...
void wrapper_51687976bd8c5c0b9b94015141d807f4()
{
    ...
    struct unique_ptr_51687976bd8c5c0b9b94015141d807f4_to_python
    {
        ...
        {
            //return boost::python::incref(boost::python::object(const_cast< class ::std::unique_ptr< class ::statiskit::VarianceEstimation, struct ::std::default_delete< class ::statiskit::VarianceEstimation > > & >(unique_ptr_51687976bd8c5c0b9b94015141d807f4).release()).ptr());
