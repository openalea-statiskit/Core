...
void wrapper_a640206684935d01aa5be922b3bbdf00()
{
    ...
    class_a640206684935d01aa5be922b3bbdf00.def(boost::python::init<  >(""));
    ...
    class_a640206684935d01aa5be922b3bbdf00.def(boost::python::init< struct ::statiskit::BinomialDistributionMLEstimation const & >(""));
