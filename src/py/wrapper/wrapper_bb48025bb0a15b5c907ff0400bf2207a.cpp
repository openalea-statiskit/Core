...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_a9c4a81ac0dd5ed19a40ff7f3f24ddd3;
            virtual return_type_a9c4a81ac0dd5ed19a40ff7f3f24ddd3 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_a9c4a81ac0dd5ed19a40ff7f3f24ddd3, class_type, copy, ); };
