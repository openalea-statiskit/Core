...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::SingularDistribution, struct ::std::default_delete< struct ::statiskit::SingularDistribution > >  return_type_c5864745a15a526abae4cd03bf6d4f57;
            virtual return_type_c5864745a15a526abae4cd03bf6d4f57 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_c5864745a15a526abae4cd03bf6d4f57, class_type, copy, ); };
