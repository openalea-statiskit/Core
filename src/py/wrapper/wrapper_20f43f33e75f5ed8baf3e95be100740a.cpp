...
void wrapper_20f43f33e75f5ed8baf3e95be100740a()
{
    ...
    class_20f43f33e75f5ed8baf3e95be100740a.def(boost::python::init< struct ::statiskit::UnivariateData const * >(""));
    class_20f43f33e75f5ed8baf3e95be100740a.def(boost::python::init< struct ::statiskit::CategoricalUnivariateDistribution const *, struct ::statiskit::UnivariateData const * >(""));
    ...
    class_20f43f33e75f5ed8baf3e95be100740a.def("get_data", method_pointer_bf88b46abf975c5ab71ed23250a7b63b, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
