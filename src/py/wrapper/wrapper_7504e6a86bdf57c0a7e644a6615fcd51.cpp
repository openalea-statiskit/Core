...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_e731d0981dfa5ad7932de7d2d4730d2d;
            virtual return_type_e731d0981dfa5ad7932de7d2d4730d2d copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_e731d0981dfa5ad7932de7d2d4730d2d, class_type, copy, ); };
