...
namespace autowig
{
    ...
    void method_decorator_d0aaaed44e815965a76dc2c3b2f63837(class ::std::vector< struct ::statiskit::ContinuousMultivariateDistribution *, class ::std::allocator< struct ::statiskit::ContinuousMultivariateDistribution * > > & instance, ::std::vector< struct ::statiskit::ContinuousMultivariateDistribution *, class ::std::allocator< struct ::statiskit::ContinuousMultivariateDistribution * > >::size_type  param_in_0, const ::std::vector< struct ::statiskit::ContinuousMultivariateDistribution *, class ::std::allocator< struct ::statiskit::ContinuousMultivariateDistribution * > >::reference  param_out) { instance.at(param_in_0) = param_out; }
    ...
    struct vector_19ec6a1f261852b5b192c3cbc4571d78_from_python
    {
        ...
        static void construct(PyObject* obj_ptr, boost::python::converter::rvalue_from_python_stage1_data* data)
        {
            ...
            for(;; i++)
            {
                ...
                result.push_back(boost::python::extract< struct ::statiskit::ContinuousMultivariateDistribution * >(py_elem_obj));
            }
        }
    };
