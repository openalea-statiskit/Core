...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::MultivariateDistribution, struct ::std::default_delete< struct ::statiskit::MultivariateDistribution > >  return_type_13ce002a16d358ed963cfab919445ca1;
            virtual return_type_13ce002a16d358ed963cfab919445ca1 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_13ce002a16d358ed963cfab919445ca1, class_type, copy, ); };
