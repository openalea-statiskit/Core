...
void wrapper_1935a142d4425b8e9212ebbb3d98b996()
{
    ...
    boost::python::class_< autowig::Wrap_1935a142d4425b8e9212ebbb3d98b996, autowig::Held< autowig::Wrap_1935a142d4425b8e9212ebbb3d98b996 >::Type, boost::python::bases< class ::statiskit::OptimizationEstimationImpl< double, class ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistributionEstimation >::Estimator >, boost::noncopyable > class_1935a142d4425b8e9212ebbb3d98b996("Estimator", "", boost::python::no_init);
    ...
    if(autowig::Held< struct ::statiskit::OptimizationEstimation< double, class ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistributionEstimation >::Estimator >::is_class)
    {
        ...
        boost::python::register_ptr_to_python< autowig::Held< struct ::statiskit::OptimizationEstimation< double, class ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistributionEstimation >::Estimator >::Type >();
