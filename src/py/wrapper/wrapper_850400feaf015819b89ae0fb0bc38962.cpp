...
class ::std::vector< std::size_t, class ::std::allocator< std::size_t > > const & (::statiskit::OrdinalSampleSpace::*method_pointer_bbbcd1f7befd501da33c8bc0a6ca7d94)()const= &::statiskit::OrdinalSampleSpace::get_rank;
void  (::statiskit::OrdinalSampleSpace::*method_pointer_106705a757c553aa881c46d55a55ded5)(class ::std::vector< std::size_t, class ::std::allocator< std::size_t > > const &)= &::statiskit::OrdinalSampleSpace::set_rank;
