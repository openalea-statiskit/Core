...
namespace autowig
{
    ...
    void method_decorator_769a75103aea5cbfad86e8b5c022c015(class ::std::unique_ptr< struct ::statiskit::SlopeHeuristicSelector, struct ::std::default_delete< struct ::statiskit::SlopeHeuristicSelector > > const & instance, const struct ::statiskit::SlopeHeuristicSelector & param_out) { instance.operator*() = param_out; }
}
...
void wrapper_b2f3c2f39c61584abb2d15ebc8f7a063()
{
    ...
    struct unique_ptr_b2f3c2f39c61584abb2d15ebc8f7a063_to_python
    {
        ...
        {
            //return boost::python::incref(boost::python::object(const_cast< class ::std::unique_ptr< struct ::statiskit::SlopeHeuristicSelector, struct ::std::default_delete< struct ::statiskit::SlopeHeuristicSelector > > & >(unique_ptr_b2f3c2f39c61584abb2d15ebc8f7a063).release()).ptr());
