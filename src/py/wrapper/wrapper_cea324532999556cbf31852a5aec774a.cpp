...
namespace boost
{
    template <> class ::std::unique_ptr< class ::statiskit::SplittingDistribution, struct ::std::default_delete< class ::statiskit::SplittingDistribution > > const volatile * get_pointer<class ::std::unique_ptr< class ::statiskit::SplittingDistribution, struct ::std::default_delete< class ::statiskit::SplittingDistribution > > const volatile >(class ::std::unique_ptr< class ::statiskit::SplittingDistribution, struct ::std::default_delete< class ::statiskit::SplittingDistribution > > const volatile *c) { return c; }
}
    #endif
#endif
