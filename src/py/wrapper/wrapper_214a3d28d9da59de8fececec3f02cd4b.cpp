...
namespace boost
{
    template <> class ::std::unique_ptr< struct ::statiskit::ContinuousUnivariateMixtureDistribution, struct ::std::default_delete< struct ::statiskit::ContinuousUnivariateMixtureDistribution > > const volatile * get_pointer<class ::std::unique_ptr< struct ::statiskit::ContinuousUnivariateMixtureDistribution, struct ::std::default_delete< struct ::statiskit::ContinuousUnivariateMixtureDistribution > > const volatile >(class ::std::unique_ptr< struct ::statiskit::ContinuousUnivariateMixtureDistribution, struct ::std::default_delete< struct ::statiskit::ContinuousUnivariateMixtureDistribution > > const volatile *c) { return c; }
}
    #endif
#endif
