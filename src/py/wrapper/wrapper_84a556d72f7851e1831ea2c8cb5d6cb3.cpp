...
namespace autowig
{
    ...
    void method_decorator_c38f91089ce155d9b417e9797b7f0346(class ::std::unique_ptr< class ::statiskit::OrdinalSampleSpace, struct ::std::default_delete< class ::statiskit::OrdinalSampleSpace > > const & instance, const class ::statiskit::OrdinalSampleSpace & param_out) { instance.operator*() = param_out; }
}
...
void wrapper_84a556d72f7851e1831ea2c8cb5d6cb3()
{
    ...
    struct unique_ptr_84a556d72f7851e1831ea2c8cb5d6cb3_to_python
    {
        ...
        {
            //return boost::python::incref(boost::python::object(const_cast< class ::std::unique_ptr< class ::statiskit::OrdinalSampleSpace, struct ::std::default_delete< class ::statiskit::OrdinalSampleSpace > > & >(unique_ptr_84a556d72f7851e1831ea2c8cb5d6cb3).release()).ptr());
