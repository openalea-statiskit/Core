...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_8212df695c38549281a6bcb634bd2f31;
            virtual return_type_8212df695c38549281a6bcb634bd2f31 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_8212df695c38549281a6bcb634bd2f31, class_type, copy, ); };
