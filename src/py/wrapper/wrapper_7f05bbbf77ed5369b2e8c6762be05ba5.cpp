...
namespace boost
{
    template <> class ::std::unique_ptr< class ::statiskit::GammaDistribution, struct ::std::default_delete< class ::statiskit::GammaDistribution > > const volatile * get_pointer<class ::std::unique_ptr< class ::statiskit::GammaDistribution, struct ::std::default_delete< class ::statiskit::GammaDistribution > > const volatile >(class ::std::unique_ptr< class ::statiskit::GammaDistribution, struct ::std::default_delete< class ::statiskit::GammaDistribution > > const volatile *c) { return c; }
}
    #endif
#endif
