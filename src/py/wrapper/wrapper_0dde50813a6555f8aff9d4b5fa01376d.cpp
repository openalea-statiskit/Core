...
void wrapper_0dde50813a6555f8aff9d4b5fa01376d()
{
    ...
    class_0dde50813a6555f8aff9d4b5fa01376d.def(boost::python::init<  >(""));
    ...
    class_0dde50813a6555f8aff9d4b5fa01376d.def(boost::python::init< class ::statiskit::IndependentMultivariateDistributionEstimation< struct ::statiskit::CategoricalMultivariateDistribution, struct ::statiskit::CategoricalMultivariateDistributionEstimation > const & >(""));
