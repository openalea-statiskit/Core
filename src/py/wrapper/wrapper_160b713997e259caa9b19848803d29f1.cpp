...
namespace autowig
{
    ...
    void method_decorator_a6c072f3d22452a0a03fc2e7fa32a0b5(class ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > > & instance, ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > >::size_type  param_in_0, const ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > >::reference  param_out) { instance.at(param_in_0) = param_out; }
    void method_decorator_9d231f8feb5a530a9be6a0a456258b64(class ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > > & instance, const ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > >::reference  param_out) { instance.front() = param_out; }
    void method_decorator_8c90f6a1688451bd89c1bacee415a70a(class ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > > & instance, const ::std::vector< struct ::statiskit::UnivariateSampleSpace *, class ::std::allocator< struct ::statiskit::UnivariateSampleSpace * > >::reference  param_out) { instance.back() = param_out; }
}
    ...
    struct vector_160b713997e259caa9b19848803d29f1_from_python
    {
        ...
        static void construct(PyObject* obj_ptr, boost::python::converter::rvalue_from_python_stage1_data* data)
        {
            ...
            for(;; i++)
            {
                ...
                result.push_back(boost::python::extract< struct ::statiskit::UnivariateSampleSpace * >(py_elem_obj));
            }
        }
    };
