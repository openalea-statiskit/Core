...
namespace autowig
{
    ...
    void method_decorator_cb48823d3bd55083b26b4347b10b3e4c(class ::std::unique_ptr< struct ::statiskit::UnivariateEvent, struct ::std::default_delete< struct ::statiskit::UnivariateEvent > > const & instance, const struct ::statiskit::UnivariateEvent & param_out) { instance.operator*() = param_out; }
}
...
void wrapper_0e41540d879f5526a70e316582f05d49()
{
    ...
    struct unique_ptr_0e41540d879f5526a70e316582f05d49_to_python
    {
        ...
        {
            //return boost::python::incref(boost::python::object(const_cast< class ::std::unique_ptr< struct ::statiskit::UnivariateEvent, struct ::std::default_delete< struct ::statiskit::UnivariateEvent > > & >(unique_ptr_0e41540d879f5526a70e316582f05d49).release()).ptr());
