...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_990d49f9e519539f96548744996a00d6;
            virtual return_type_990d49f9e519539f96548744996a00d6 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_990d49f9e519539f96548744996a00d6, class_type, copy, ); };
