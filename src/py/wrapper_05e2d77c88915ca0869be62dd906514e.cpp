...
namespace boost
{
    template <> class ::statiskit::Optimization const volatile * get_pointer<class ::statiskit::Optimization const volatile >(class ::statiskit::Optimization const volatile *c) { return c; }
}
    #endif
#endif
