...
namespace autowig
{
    ...
    void method_decorator_1dab164edf8157aaa93f971c9d104e3d(class ::std::vector< struct ::statiskit::DiscreteUnivariateDistribution *, class ::std::allocator< struct ::statiskit::DiscreteUnivariateDistribution * > > & instance, ::std::vector< struct ::statiskit::DiscreteUnivariateDistribution *, class ::std::allocator< struct ::statiskit::DiscreteUnivariateDistribution * > >::size_type  param_in_0, ::std::vector< struct ::statiskit::DiscreteUnivariateDistribution *, class ::std::allocator< struct ::statiskit::DiscreteUnivariateDistribution * > >::reference  param_out)     { instance.at(param_in_0) = param_out; }
    void method_decorator_364c56ff3f415b51b9f5327368b56cdf(class ::std::vector< struct ::statiskit::DiscreteUnivariateDistribution *, class ::std::allocator< struct ::statiskit::DiscreteUnivariateDistribution * > > & instance, ::std::vector< struct ::statiskit::DiscreteUnivariateDistribution *, class ::std::allocator< struct ::statiskit::DiscreteUnivariateDistribution * > >::reference  param_out)     { instance.front() = param_out; }
    ...
    struct vector_ce6d678c114158f596627eb4f0c6e9b1_from_python
    {
        ...
        static void construct(PyObject* obj_ptr, boost::python::converter::rvalue_from_python_stage1_data* data)
        {
            ...
            for(;; i++)
            {
                ...
                result.push_back((struct ::statiskit::DiscreteUnivariateDistribution *)(boost::python::extract< struct ::statiskit::DiscreteUnivariateDistribution * >(py_elem_obj)));
            }
        }
    };
