...
namespace boost
{
    template <> class ::statiskit::WeightedUnivariateDataFrame const volatile * get_pointer<class ::statiskit::WeightedUnivariateDataFrame const volatile >(class ::statiskit::WeightedUnivariateDataFrame const volatile *c) { return c; }
}
    #endif
#endif
