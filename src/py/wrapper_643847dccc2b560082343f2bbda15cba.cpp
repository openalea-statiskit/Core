...
void wrapper_643847dccc2b560082343f2bbda15cba()
{
    ...
    boost::python::class_< class ::statiskit::SlopeHeuristicIWLSSolver, autowig::Held< class ::statiskit::SlopeHeuristicIWLSSolver >::Type, boost::python::bases< class ::statiskit::SlopeHeuristicSolver >, boost::noncopyable > class_643847dccc2b560082343f2bbda15cba("SlopeHeuristicIWLSSolver", "", boost::python::no_init);
