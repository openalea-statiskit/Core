...
void wrapper_aabf684ce17950b49b6345c1ab565540()
{
    ...
    class_aabf684ce17950b49b6345c1ab565540.def(boost::python::init< class ::std::shared_ptr< class ::statiskit::NormalDistribution > const &, class ::std::shared_ptr< struct ::statiskit::UnivariateData > const & >(""));
