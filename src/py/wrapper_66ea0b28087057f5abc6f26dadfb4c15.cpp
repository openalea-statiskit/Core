...
void wrapper_66ea0b28087057f5abc6f26dadfb4c15()
{
    ...
    class_66ea0b28087057f5abc6f26dadfb4c15.def(boost::python::init< class ::std::shared_ptr< class ::statiskit::NegativeBinomialDistribution > const &, class ::std::shared_ptr< struct ::statiskit::UnivariateData > const & >(""));
    ...
    class_66ea0b28087057f5abc6f26dadfb4c15.def("get_data", method_pointer_71f5e339e3a65e4f8fd12e1b4f2e128d, boost::python::return_value_policy< boost::python::return_by_value >(), "");
