...
void wrapper_19ee605677815ce58ebdc169d44e3d8c()
{
    ...
    class_19ee605677815ce58ebdc169d44e3d8c.def(boost::python::init< class ::std::shared_ptr< class ::statiskit::NormalDistribution > const &, class ::std::shared_ptr< struct ::statiskit::UnivariateData > const & >(""));
    ...
    class_19ee605677815ce58ebdc169d44e3d8c.def("get_data", method_pointer_e955cd2b8e7c5286a371643be63bcf14, boost::python::return_value_policy< boost::python::return_by_value >(), "");
