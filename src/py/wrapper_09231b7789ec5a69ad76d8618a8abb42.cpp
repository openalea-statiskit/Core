...
void wrapper_09231b7789ec5a69ad76d8618a8abb42()
{
    ...
    ::std::size_t  (::statiskit::IndependentMultivariateDistribution< ::statiskit::MultivariateDistribution >::*method_pointer_d6dcb19cd8845cd1962775482adb15eb)() const = &::statiskit::IndependentMultivariateDistribution< struct ::statiskit::MultivariateDistribution >::get_nb_variables;
    ...
    struct ::statiskit::UnivariateDistribution * (::statiskit::IndependentMultivariateDistribution< ::statiskit::MultivariateDistribution >::*method_pointer_0bc7c80b6dd75d4b91a14c6f2d03eb23)(::std::size_t const &) const = &::statiskit::IndependentMultivariateDistribution< struct ::statiskit::MultivariateDistribution >::get_marginal;
    void  (::statiskit::IndependentMultivariateDistribution< ::statiskit::MultivariateDistribution >::*method_pointer_a83f7acc7f9651a49ee108595138cf88)(::std::size_t const &, struct ::statiskit::UnivariateDistribution const &) = &::statiskit::IndependentMultivariateDistribution< struct ::statiskit::MultivariateDistribution >::set_marginal;
    ...
    boost::python::class_< class ::statiskit::IndependentMultivariateDistribution< struct ::statiskit::MultivariateDistribution >, autowig::Held< class ::statiskit::IndependentMultivariateDistribution< struct ::statiskit::MultivariateDistribution > >::Type, boost::python::bases< struct ::statiskit::MultivariateDistribution >, boost::noncopyable > class_09231b7789ec5a69ad76d8618a8abb42("_IndependentMultivariateDistribution_09231b7789ec5a69ad76d8618a8abb42", "", boost::python::no_init);
    class_09231b7789ec5a69ad76d8618a8abb42.def("get_sample_space", method_pointer_55d58d8519125b0f9d94e963e234f336, "");
    class_09231b7789ec5a69ad76d8618a8abb42.def("get_nb_variables", method_pointer_d6dcb19cd8845cd1962775482adb15eb, "");
