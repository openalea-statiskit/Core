...
void wrapper_09231b7789ec5a69ad76d8618a8abb42()
{
    ...
    ::statiskit::Index  (::statiskit::IndependentMultivariateDistribution< ::statiskit::MultivariateDistribution >::*method_pointer_d6dcb19cd8845cd1962775482adb15eb)() const = &::statiskit::IndependentMultivariateDistribution< struct ::statiskit::MultivariateDistribution >::get_nb_variables;
