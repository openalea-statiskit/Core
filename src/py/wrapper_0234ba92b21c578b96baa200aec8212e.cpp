...
void wrapper_0234ba92b21c578b96baa200aec8212e()
{
    ...
    ::statiskit::Index  (::statiskit::IndependentMultivariateDistribution< ::statiskit::DiscreteMultivariateDistribution >::*method_pointer_0f66206ff05c5fac9b08087ac5d95c84)() const = &::statiskit::IndependentMultivariateDistribution< struct ::statiskit::DiscreteMultivariateDistribution >::get_nb_variables;
