...
void wrapper_0234ba92b21c578b96baa200aec8212e()
{
    ...
    boost::python::class_< class ::statiskit::IndependentMultivariateDistribution< struct ::statiskit::DiscreteMultivariateDistribution >, autowig::Held< class ::statiskit::IndependentMultivariateDistribution< struct ::statiskit::DiscreteMultivariateDistribution > >::Type, boost::python::bases< struct ::statiskit::DiscreteMultivariateDistribution >, boost::noncopyable > class_0234ba92b21c578b96baa200aec8212e("_IndependentMultivariateDistribution_0234ba92b21c578b96baa200aec8212e", "", boost::python::no_init);
